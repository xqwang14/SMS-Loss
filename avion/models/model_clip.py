...
##from avion.models.transformer_rope import TextTransformer, VisionTransformer
from avion.models.transformer import TextTransformer, VisionTransformer
from avion.models.utils import enable_grad_checkpointing, remap_keys_from_open_clip_to_vit, remap_state_dict_keys
...
def CLIP_VITB16(
    ...
    **kwargs
    ...
    vision_model = VisionTransformer(
        224, 16, 768, 12, 12, 4,
        #use_rot_pos_emb = True, #2024/5/22 Add RoPE
